...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-jz=tn41p6v^yi@+=0auqv_5xwdt=1e@g!3luggscg=5t%q@o^i')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'xanatz_db'),
        'USER': os.environ.get('DB_USER', 'root'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'akshaytr'),
