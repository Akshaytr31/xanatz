...
import { MapPin, Globe, ArrowUpRight, ChevronDown, Sparkles, Briefcase, ShieldCheck, Award } from "lucide-react";
...
const PublicHero = ({ profile, first_name, last_name, fullName, heroY, heroOpacity }) => {
  const currentCompany = profile?.experiences?.find(exp => exp.current)?.company;
  ...
  return (
    <section
      ...
      style={{ minHeight: "auto", paddingTop: "6.5rem", paddingBottom: "3rem", alignItems: "center", paddingLeft: "clamp(2rem, 7vw, 10rem)", paddingRight: "clamp(2rem, 7vw, 10rem)" }}
    >
      {/* Ambient glow */}
      <div style={{
        position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)",
        width: "800px", height: "280px", pointerEvents: "none", opacity: 0.14,
        background: "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(59,130,246,0.8), transparent)",
        filter: "blur(50px)",
      }} />
      ...
      <div className="pub-inner" style={{ position: "relative", zIndex: 10 }}>
        ...
        <div
          ...
          style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1rem", alignItems: "center", justifyItems: "center" }}
        >
          ...
          >
            ...
            {/* Badges Row */}
            <motion.div variants={fadeUp} style={{ display: "flex", flexWrap: "wrap", gap: "0.6rem", marginBottom: "1rem" }}>
              {/* Status badge */}
              <span style={{
                ...
                <span style={{ width: "5px", height: "5px", borderRadius: "50%", background: "#4ade80", boxShadow: "0 0 7px #4ade80", flexShrink: 0 }} />
            ...
            <motion.p variants={fadeUp} style={{
              ...
              fontSize: "clamp(0.85rem, 1.6vw, 1rem)", lineHeight: 1.6,
              ...
              <motion.div variants={fadeUp} style={{
                ...
                {profile?.location && (
                  <span style={{
                    ...
                    fontSize: "0.74rem", fontWeight: 600, color: "#93c5fd",
                  }}>
            ...
            {/* Divider */}
            <motion.div variants={fadeUp} style={{
              height: "1px", maxWidth: "260px", marginBottom: "1rem",
              background: "linear-gradient(90deg, rgba(59,130,246,0.4), rgba(139,92,246,0.3), transparent)",
            }} />

            {/* Scroll hint */}
            <motion.div variants={fadeUp} style={{
              display: "inline-flex", alignItems: "center", gap: "0.5rem", color: "#374151",
            }}>
          ...
          >
            ...
            <div style={{
              ...
              borderRadius: "2rem", opacity: 0.3, pointerEvents: "none",
              background: "radial-gradient(circle, rgba(59,130,246,0.4), rgba(139,92,246,0.2), transparent 65%)",
              filter: "blur(24px)",
            }} />
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: "linear-gradient(to top, rgba(2,6,23,0.88) 0%, rgba(2,6,23,0.1) 38%, transparent 62%)",
                  }} />
...
{/*           
              <motion.div
                ...
                style={{
                  position: "absolute", top: "1rem", right: "-0.9rem", zIndex: 30,
