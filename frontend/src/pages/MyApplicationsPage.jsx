...
const MyApplicationsPage = () => {
  ...
  return (
    <Box minH="100vh" bg="var(--color-primary)" position="relative" overflow="hidden" pb="120px">
      ...
      <Box position="relative" zIndex={1}>
        ...
        <Container maxW="900px" px={{ base: 5, md: 8 }} pt={24}>
          ...
          <VStack align="start" gap={1} mb={8}>
            ...
            <HStack gap={3}>
              ...
              <Box px={2.5} py={0.5} borderRadius="full" style={{ background: "rgba(59,130,246,0.12)", border: "1px solid rgba(59,130,246,0.25)" }}>
            ...
            <Text color="rgba(255,255,255,0.4)" fontSize="xs" fontWeight="medium">
              View your submission status, review records, and tracking pipeline
            </Text>
          </VStack>
